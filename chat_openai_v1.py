...
st.set_page_config(
    ...
    page_icon="data/avatar_streamly.png",
    layout="wide",
...
def main():
    ...
    img_path = "data/sidebar_streamly_avatar.png"
    ...
    img_path = "data/stsidebarimg.png"
    img_base64 = img_to_base64(img_path)
    if img_base64:
        st.sidebar.markdown(
            f'<img src="data:image/png;base64,{img_base64}" class="cover-glow">',
    ...
    if mode == "Chat with Streamly":
        ...
        for message in st.session_state.history[-NUMBER_OF_MESSAGES_TO_DISPLAY:]:
            role = message["role"]
            avatar_image = "data/avatar_streamly.png" if role == "assistant" else "data/stuser.png" if role == "user" else None
